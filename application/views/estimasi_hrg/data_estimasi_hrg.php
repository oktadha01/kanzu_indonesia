    ...
    <div class="col-xxl-3 col-lg-4 col-md-6 col-12" data-aos="zoom-in" data-aos-delay="200">
        <div class="service-item" style="background: #d3d3d317;border-radius: 6px;">
            <?php
                ...
                ?>
            <a
                href="<?php echo base_url('detail'); ?>/perum/<?php echo $tittle; ?>/tipe/<?php echo $data->luas_bangunan; ?>/<?php echo $data->luas_tanah; ?>">
                <div class="img border-r-0px" style="position: relative;">
                    <img src="<?php echo base_url('upload'); ?>/<?php echo $foto->foto_tipe; ?>"
                        srcset="<?php echo base_url('upload'); ?>/<?php echo $foto->foto_tipe; ?> 1x, <?php echo base_url('upload'); ?>/<?php echo $foto->foto_tipe; ?> 3x"
                        class=" size-img-dash img-fluid"
            ...
            <div class="m-2">
                ...
                <a class="btn-hrg-dash"
                    href="<?php echo base_url('detail'); ?>/perum/<?php echo $tittle; ?>/tipe/<?php echo $data->luas_bangunan; ?>/<?php echo $data->luas_tanah; ?>">Rp
                    <?php echo $data->hrg; ?> <sub><?php echo $data->satuan_hrg; ?></sub></a>
                ...
                <a
                    ...
                    <button type="button" id=""
                        class="btn btn-sm mb-2 btn-outline-info"><?php echo $data->luas_bangunan; ?>/<?php echo $data->luas_tanah; ?></button>
                </a>
                <br>
                <span class="mb-0 font-text-port"> <?php echo $data->alamat; ?></span>
                <div style="text-align-last: justify;">
                    <div class="figure">
                        <img src="<?php echo base_url('assets'); ?>/img/ikon-display/ru-tamu.png"
                            class="size-ikon-dash img-fluid" alt="">
                        <h6><?php echo $data->r_tamu; ?></h6>
                    </div>
                    <div class="figure">
                        <img src="<?php echo base_url('assets'); ?>/img/ikon-display/ka-tidur.png"
                            class="size-ikon-dash img-fluid" alt="">
                        <h6><?php echo $data->k_tidur; ?></h6>
                    </div>
                    <div class="figure">
                        <img src="<?php echo base_url('assets'); ?>/img/ikon-display/ka-mandi.png"
                            class="size-ikon-dash img-fluid" alt="">
                        <h6><?php echo $data->k_mandi; ?></h6>
                    </div>
                    <div class="figure">
                        <img src="<?php echo base_url('assets'); ?>/img/ikon-display/dapur.png"
                            class="size-ikon-dash img-fluid" alt="">
